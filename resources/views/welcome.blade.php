...
<body class="bg-teal-100">
    ...
    <div class="info flex flex-col items-center mt-10 h-full">
        <h2 class="text-3xl font-semibold mt-10 pt-10">Nama: {{ $nama }}</h2>
        <h2 class="text-3xl font-semibold mt-5 pt-5">Kelas: {{ $kelas }}</h2>
    </div>
</body>
</html>